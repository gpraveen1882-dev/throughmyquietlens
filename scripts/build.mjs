...
function footer() {
  return `<footer><div class="container"><div class="footer-grid"><div><div class="footer-brand"><img src="/images/logo-quiet-lens.png" alt="Through My Quiet Lens" class="footer-logo"></div><p class="footer-note">Experience, inquiry and reflection on how we live, work and respond to change.</p></div><div class="footer-links"><a href="/writing/">Writing</a><a href="/through-my-quiet-lens/">Quiet Lens</a><a href="/principles/">Working Principles</a><a href="/dc-decoded/">DC Decoded</a><a href="/ucla-anderson/">UCLA Anderson</a><a href="/library/">All Writing</a><a href="/projects/">Ideas in Practice</a><a href="/conversations/">Conversations</a><a href="/about/">About</a><a href="/contact/">Contact</a><a href="/subscribe/">Subscribe</a><a href="${esc(site.linkedin)}" target="_blank" rel="noopener noreferrer">LinkedIn</a></div></div><div class="copyright">© <span class="year"></span> ${esc(site.author)}. Built for reading, not scrolling.</div></div></footer>`;
}
...
const home = `<section class="home-hero home-hero-v3"><div class="container home-hero-inner"><p class="home-thankyou">Thank you for choosing to pause &amp; explore instead of scroll.</p><h1>Some ideas only reveal themselves when we slow down long enough to look again.</h1><p class="home-deck">Through My Quiet Lens explores the questions and tensions shaping how we live, work and respond to change—through experience, inquiry and reflection.</p><div class="home-hero-actions"><a class="button" href="/writing/">Explore the writing →</a><a class="text-button" href="/about/">Behind the lens →</a></div></div></section>
<section class="section home-featured"><div class="container"><p class="eyebrow">Featured thinking</p><article class="home-featured-story"><div><p class="feature-kicker">An idea worth staying with</p><h2><a href="${homeFeaturedUrl}">${esc(homeFeatured?.displayTitle || homeFeatured?.title || 'Explore the writing')}</a></h2></div><div><p>${esc(homeFeatured?.description || '')}</p><a class="read-link" href="${homeFeaturedUrl}">Read the essay →</a></div></article></div></section>
