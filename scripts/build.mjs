...
const sage = `<section class="page-hero"><div class="container"><p class="eyebrow">Public initiative</p><h1 class="page-title">PAUSE for AI</h1><p class="page-lead">A developing platform for thoughtful, sustainable and responsible engagement with artificial intelligence.</p></div></section><section class="section"><div class="reading project-story"><h2>Why PAUSE</h2><p>AI is becoming part of ordinary work and life faster than most people have had time to think about how they use it. PAUSE for AI begins from a simple belief: better technology use is not only about capability. It is also about judgement, restraint and awareness of impact.</p><h2>What it is becoming</h2><p>PAUSE for AI will translate research and complex sustainability questions into accessible habits, experiments and conversations. The Sustainable AI study is one early research stream within that broader direction.</p><h2>Current stage</h2><p>The initiative is still being shaped. Its first phase focuses on building a clear evidence base, sharing practical guidance and developing a community interested in using AI with greater intention.</p><blockquote><p>Use intelligence wisely, both the machine's and our own.</p></blockquote><p class="back-link"><a href="/projects/">← Back to Projects</a></p></div></section>`;
write('projects/pause-for-ai', layout({title:'PAUSE for AI', description:'A developing initiative for sustainable and thoughtful AI use.', body:sage, active:'projects', canonical:'/projects/pause-for-ai/'}));
