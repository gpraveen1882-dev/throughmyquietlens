...
<article class="journey-stop"><span class="journey-number">01</span><img src="/images/about/journey-chennai.jpg" alt="Chennai chapter" loading="lazy"><h3>Chennai</h3><p class="journey-kicker">Early foundations</p><p>Rooted in a family of teachers, and in the belief that learning should lead to contribution.</p></article>
...
<figure class="about-photo about-photo-tall"><img src="/images/about/moment-writing.jpg" alt="Writing and reflection" loading="lazy"><figcaption><strong>Writing</strong><span>Slowing down enough to notice.</span></figcaption></figure>
</div></div></section>
