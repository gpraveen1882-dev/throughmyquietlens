...
<section class="section home-recent"><div class="container"><p class="eyebrow">Recent Writing</p><div class="home-recent-list">${homeLatest.map(e=>`<article class="home-recent-item"><h2><a href="${homeLatestUrl(e)}">${esc(e.displayTitle || e.title)}</a></h2><p>${esc(e.homeIntro || e.description)}</p><a class="read-link" href="${homeLatestUrl(e)}">Read →</a></article>`).join('')}</div><p class="home-explore-all"><a href="/library/">Explore all writing →</a></p></div></section>
...
<article class="journey-stop"><span class="journey-number">02</span><img src="/images/about/journey-godrej.jpg" alt="South India chapter placeholder" loading="lazy"><h3>South India</h3><p class="journey-kicker">Learning on the ground</p><p>Eight years building dealer networks and delivering projects across South India, the first real lesson in how differently people think, decide and trust, depending on where you meet them.</p></article>
