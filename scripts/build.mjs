...
const projects = `<section class="page-hero"><div class="container"><p class="eyebrow">From reflection to action</p><h1 class="page-title">Ideas in Practice</h1><p class="page-lead">Some questions stay on the page. Others make me want to test, build or learn something in the real world. These are some of those experiments.</p></div></section><section class="section projects-section"><div class="container"><p class="projects-stage-note">These projects are not all at the same stage. Each is shown for what it is now: an idea being explored, a working prototype, or something being tested with people and evidence.</p></div><div class="container project-grid"><article class="project-card"><p class="eyebrow">Sustainable AI</p><p class="project-status"><span>Current state</span> Testing with a small group · expanding the participant study</p><h2>Sustainable AI Initiative</h2><p>Can a simple change in how AI responds reduce unnecessary output while preserving usefulness? An initial pilot produced an encouraging signal; the study is now expanding.</p><a class="read-link" href="/projects/green-ai/">Explore the study →</a></article><article class="project-card"><p class="eyebrow">Responsible AI use</p><p class="project-status"><span>Current state</span> Developing through live experiments</p><h2>PAUSE for AI</h2><p>A practical framework for using artificial intelligence more thoughtfully, efficiently and responsibly—without losing the human judgement that gives the tool value.</p><a class="read-link" href="/projects/pause-for-ai/">Explore PAUSE for AI →</a></article><article class="project-card vent-project-card"><p class="eyebrow">Listening</p><p class="project-status"><span>Current state</span> Exploring the need</p><h2>Vent-it</h2><p>Sometimes, before people need advice or answers, they simply need somewhere to speak and someone willing to listen without judgment.</p><a class="read-link" href="/projects/vent-it/">Why I keep thinking about this →</a></article></div></section>`;
const refinedProjects = projects
  .replace('These are some of those experiments.', 'These are some of those explorations.')
  .replace('Developing through live experiments</p><h2>PAUSE for AI</h2><p>A practical framework for using artificial intelligence more thoughtfully, efficiently and responsibly—without losing the human judgement that gives the tool value.', 'Developing through research and small experiments</p><h2>PAUSE for AI</h2><p>The wider inquiry behind the Sustainable AI study—exploring resource visibility, lower-waste AI use and the human judgement we should preserve.');
write('projects', layout({title:'Ideas in Practice', description:'Questions being explored, tested and built by Praveen Gangaraju.', body:refinedProjects, active:'projects', canonical:'/projects/'}));
...
const greenAIWithState = greenAI.replace('<p class="eyebrow">Research initiative · Registration open</p>', '<p class="eyebrow">Research initiative</p><p class="project-status project-status-hero"><span>Current state</span> Testing with a small group · registration open</p>');
write('projects/green-ai', layout({title:'Sustainable AI Initiative', description:'An expanding study of sustainable everyday AI use and response efficiency.', body:greenAIWithState, active:'projects', canonical:'/projects/green-ai/'}));
...
const sageWithState = sage.replace('<p class="eyebrow">Thoughtful, sustainable and responsible AI use</p>', '<p class="eyebrow">Thoughtful, sustainable and responsible AI use</p><p class="project-status project-status-hero"><span>Current state</span> Developing through research and small experiments</p>');
write('projects/pause-for-ai', layout({title:'PAUSE for AI', description:'An independent initiative exploring lower-waste AI use, resource visibility and the preservation of human judgement.', body:sageWithState, active:'projects', canonical:'/projects/pause-for-ai/'}));
...
const ventItWithState = ventIt.replace('<p class="eyebrow">An idea about listening</p>', '<p class="eyebrow">An idea about listening</p><p class="project-status project-status-hero"><span>Current state</span> Exploring the need</p>');
