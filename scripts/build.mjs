...
function layout({title=site.title, description=site.description, body, active='', canonical='/', image='/images/logo-quiet-lens.png'}) {
...
for (const e of essays) {
  ...
  write(`essays/${e.slug}`, layout({title:e.title, description:e.description, body, active:'essays', canonical:`/essays/${e.slug}/`, image:e.image || '/images/logo-quiet-lens.png'}));
}
