...
const dateHtml = (e) => `<span>${esc(e.collection || e.source || 'Essay')}</span>`;
...
const articleBody = (e) => cleanLinkedInHtml(e.bodyHtml || (e.body || []).map(p=>`<p>${esc(p)}</p>`).join(''));
const sourceNote = (e) => e.source ? `<div class="source-note">Originally published on ${esc(e.source)}${e.date ? ` on ${prettyDate(e.date)}` : ''}. Preserved here as part of the Through My Quiet Lens archive.</div>` : '';
...
function footer() {
  return `<footer><div class="container"><div class="footer-grid"><div><div class="footer-brand">Through My Quiet Lens</div><p>Thoughtful observations by ${esc(site.author)}.</p></div><div class="footer-links"><a href="/library/">Library</a><a href="/through-my-quiet-lens/">Quiet Lens</a><a href="/essays/">Essays</a><a href="/principles/">Principles</a><a href="/ucla-anderson/">UCLA Anderson</a><a href="/conversations/">Conversations</a><a href="/dc-decoded/">DC Decoded</a><a href="/projects/">Projects</a><a href="/about/">About</a><a href="/contact/">Contact</a><a href="/subscribe/">Subscribe</a><a href="${esc(site.linkedin)}" target="_blank" rel="noopener noreferrer">LinkedIn</a></div></div><div class="copyright">© <span class="year"></span> ${esc(site.author)}. Built for reading, not scrolling.</div></div></footer>`;
}
...
const home = `<section class="home-hero"><div class="container home-hero-inner"><p class="eyebrow">An independent publication by Praveen Gangaraju</p><h1>Through My Quiet Lens</h1><p class="home-deck">Clear-eyed writing on data centres, infrastructure and AI, plus the reflections on leadership and life that shape how I think about them.</p><div class="home-actions"><a class="button" href="/dc-decoded/">Read DC Decoded →</a><a class="text-button" href="/essays/">Browse the essays →</a></div><p class="home-note">15+ years building infrastructure markets across Asia and the US. Writing to think clearly, in public.</p></div></section>
<section class="home-intro section"><div class="container home-intro-grid"><p class="eyebrow">Why I write</p><div><h2>I did not begin writing because I had answers.</h2><p class="home-intro-lead">I began because slowing down long enough to put thoughts into words often revealed questions I had not realised I was asking.</p><p>Some essays come from boardrooms. Others from classrooms, conversations, family, or ordinary moments that quietly changed how I think. This website is where I continue that conversation.</p></div></div></section>
<section class="section home-start" id="start-here"><div class="container"><div class="section-head"><div><p class="eyebrow">A considered beginning</p><h2>Start here</h2></div><p>Five entry points into the ideas, experiences and questions behind this publication.</p></div><div class="start-list">
<a class="start-item" href="/essays/gratitude/"><span class="start-no">01</span><div><span class="start-kicker">Where everything begins</span><h3>Gratitude</h3><p>A reflection on the people and sacrifices that quietly shape a life.</p></div><span class="start-arrow">→</span></a>
<a class="start-item" href="/principles/the-contract-is-the-beginning/"><span class="start-no">02</span><div><span class="start-kicker">How I think about trust</span><h3>The Contract Is the Beginning</h3><p>Why signing the agreement is only the start of the relationship.</p></div><span class="start-arrow">→</span></a>
<a class="start-item" href="/ucla-anderson/anderson-gave-me-a-village/"><span class="start-no">03</span><div><span class="start-kicker">Why community matters</span><h3>Anderson Gave Me a Village</h3><p>What an MBA taught me about belonging, contribution and shared journeys.</p></div><span class="start-arrow">→</span></a>
<a class="start-item" href="/projects/green-ai/"><span class="start-no">04</span><div><span class="start-kicker">Technology needs responsibility</span><h3>Green AI</h3><p>A practical experiment in reducing the computational waste of everyday AI use.</p></div><span class="start-arrow">→</span></a>
<a class="start-item" href="/essays/finding-my-voice/"><span class="start-no">05</span><div><span class="start-kicker">Why I write</span><h3>Finding My Voice</h3><p>Learning that a quiet voice does not have to be an invisible one.</p></div><span class="start-arrow">→</span></a>
</div></div></section>
<section class="section home-collections"><div class="container"><div class="section-head"><div><p class="eyebrow">The shelves</p><h2>Explore by collection</h2></div><a href="/library/">View the complete library →</a></div><div class="home-collection-list">
<a href="/through-my-quiet-lens/"><span>01</span><div><h3>Through My Quiet Lens</h3><p>Personal reflections on work, life, family and growth.</p></div><b>→</b></a>
<a href="/principles/"><span>02</span><div><h3>Working Principles</h3><p>Leadership, trust, negotiation and commercial judgement.</p></div><b>→</b></a>
<a href="/ucla-anderson/"><span>03</span><div><h3>UCLA Anderson</h3><p>Learning, curiosity, community and the people behind the degree.</p></div><b>→</b></a>
<a href="/dc-decoded/"><span>04</span><div><h3>DC Decoded</h3><p>Clear-eyed writing on data centres and critical infrastructure.</p></div><b>→</b></a>
<a href="/projects/green-ai/"><span>05</span><div><h3>Green AI</h3><p>Research and experiments for more sustainable use of technology.</p></div><b>→</b></a>
<a href="/projects/sage-for-ai/"><span>06</span><div><h3>SAGE for AI</h3><p>Better human–AI decisions through judgement, restraint and awareness.</p></div><b>→</b></a>
</div></div></section>
<section class="home-quote"><div class="reading"><blockquote>“Writing is not about having the answers. It is about slowing down enough to ask better questions.”</blockquote></div></section>
<section class="section home-latest"><div class="container"><div class="section-head"><div><p class="eyebrow">New on the shelf</p><h2>Latest writing</h2></div><a href="/library/">Browse all writing →</a></div><div class="cards">${homeLatest.map(e=>`<article class="card"><div class="meta"><span>${prettyDate(e.date)}</span><span>${e.readingTime}</span></div><h3><a href="${homeLatestUrl(e)}">${esc(e.displayTitle || e.title)}</a></h3><p>${esc(e.description)}</p><a class="read-link" href="${homeLatestUrl(e)}">Read →</a></article>`).join('')}</div></div></section>
<section class="section home-about"><div class="container home-about-grid"><p class="eyebrow">Behind the lens</p><div><h2>Hi, I’m Praveen.</h2><p class="home-about-lead">Commercial leader. Lifelong learner. Occasional photographer. Always curious.</p><p>I have spent more than fifteen years building markets, relationships and infrastructure businesses across India, Singapore and the United States. Here, I write about the ideas behind that experience, and the quieter lessons that came from classrooms, conversations, family and life.</p><div class="home-about-links"><a href="/about/">Read my story →</a><a href="/contact/">Start a conversation →</a></div></div></div></section><section class="section home-thanks"><div class="container"><p class="home-thanks-text">Thank you for giving this piece your time. I believe it is the biggest gift anyone can give.</p></div></section>`;
...
const libraryCollections = [
  ...
  ['Green AI','/projects/green-ai/','A practical research experiment into lower-waste everyday AI use.'],
...
<section class="section"><div class="container"><div class="section-head"><div><p class="eyebrow">Everything</p><h2>Browse all writing</h2></div><p>${essays.length + principles.length + dc.length} published pieces across the main written collections.</p></div><div class="library-all">${[...essays.map(e=>({...e,url:`/essays/${e.slug}/`})),...principles.map(e=>({...e,collection:'Working Principles',url:`/principles/${e.slug}/`,description:e.text})),...dc.map(e=>({...e,collection:'DC Decoded',url:`/dc-decoded/${e.slug}/`}))].map(e=>`<article><div class="meta"><span>${esc(e.collection)}</span><span>${esc(e.readingTime||'2 min read')}</span></div><h3><a href="${e.url}">${esc(e.title)}</a></h3><p>${esc(e.description||'')}</p></article>`).join('')}</div></div></section>`;
...
for (const e of essays) {
  const body = `<article><header class="article-head"><div class="reading"><p class="eyebrow">Essay</p><h1>${esc(e.displayTitle || e.title)}</h1>${e.subtitle ? `<p class="article-subtitle">${esc(e.subtitle)}</p>` : ``}<p class="deck">${esc(e.description)}</p><div class="meta">${dateHtml(e)}<span>${e.readingTime}</span></div>${tagHtml(e.tags)}</div></header><div class="article reading">${articleBody(e)}${sourceNote(e)}<aside class="article-subscribe"><p class="eyebrow">Stay in touch</p><h2>Enjoyed this reflection?</h2><p>Receive future essays directly in your inbox.</p><a class="button" href="/subscribe/">Subscribe →</a></aside>${readNextHtml(e)}</div></article>`;
...
const projects = `<section class="page-hero"><div class="container"><p class="eyebrow">Research & initiatives</p><h1 class="page-title">Projects</h1><p class="page-lead">Work that moves beyond reflection into experiments, tools and communities built around an idea.</p></div></section><section class="section"><div class="container project-grid"><article class="project-card"><p class="eyebrow">Research experiment</p><h2>Green AI</h2><p>Can a small change in how we prompt AI reduce unnecessary computation without reducing usefulness? This project began with a simple custom instruction and a small cross-model pilot.</p><a class="read-link" href="/projects/green-ai/">Explore Green AI →</a></article><article class="project-card"><p class="eyebrow">Public initiative</p><h2>SAGE for AI</h2><p>A developing initiative focused on more thoughtful, sustainable and responsible everyday use of artificial intelligence.</p><a class="read-link" href="/projects/sage-for-ai/">Explore SAGE for AI →</a></article></div></section>`;
...
const greenAI = `<section class="page-hero"><div class="container"><p class="eyebrow">Research experiment</p><h1 class="page-title">Green AI</h1><p class="page-lead">Testing whether a small behavioural intervention can reduce the computational waste hidden inside everyday AI use.</p></div></section><section class="section"><div class="reading project-story"><h2>The question</h2><p>Most conversations about AI sustainability focus on data centres, model architecture and energy supply. Those questions matter. But there is also a quieter question on the demand side: can ordinary users reduce unnecessary output through better defaults?</p><h2>The experiment</h2><p>The first pilot tested one short custom instruction designed to encourage concise, direct answers. Eleven participants used ChatGPT, Claude and Gemini without changing models or receiving prompt-engineering training.</p><div class="project-stat"><strong>About 65%</strong><span>average reduction in output tokens during the initial pilot</span></div><p>The early result is not a final scientific conclusion. It is a signal worth testing more carefully: small behavioural interventions may help reduce computational demand while preserving usefulness.</p><h2>What comes next</h2><p>The next stage expands the sample, improves measurement and tests whether the intervention remains useful across different tasks and user groups. The larger goal is to make sustainable AI use practical rather than abstract.</p><p class="back-link"><a href="/projects/">← Back to Projects</a></p></div></section>`;
write('projects/green-ai', layout({title:'Green AI', description:'A behavioural experiment exploring lower-waste everyday AI use.', body:greenAI, active:'projects', canonical:'/projects/green-ai/'}));
...
<article class="journey-stop"><span class="journey-number">01</span><img src="/images/about/journey-chennai.jpg" alt="Chennai chapter placeholder" loading="lazy"><h3>Chennai</h3><p class="journey-kicker">Early foundations</p><p>Rooted in a family of teachers, and in the belief that learning should lead to contribution.</p></article>
<article class="journey-stop"><span class="journey-number">02</span><img src="/images/about/journey-singapore.jpg" alt="Singapore chapter placeholder" loading="lazy"><h3>Singapore</h3><p class="journey-kicker">Building, leading and belonging</p><p>Learning through work, building markets, teams and relationships across complex projects.</p></article>
<article class="journey-stop"><span class="journey-number">03</span><img src="/images/about/journey-united-states.jpg" alt="United States and UCLA chapter placeholder" loading="lazy"><h3>United States & UCLA</h3><p class="journey-kicker">Stepping back to move forward</p><p>A new country, a new classroom and a community that renewed my curiosity.</p></article>
<article class="journey-stop"><span class="journey-number">04</span><img src="/images/about/journey-return.jpg" alt="Return to Singapore chapter placeholder" loading="lazy"><h3>Singapore, again</h3><p class="journey-kicker">A new chapter</p><p>Returning with a wider lens, and a clearer sense of the work and impact I want to create.</p></article>
</div></div></section>
<section class="section about-moments"><div class="container"><div class="section-head"><div><p class="eyebrow">Moments that shaped me</p><h2>The life behind the writing.</h2></div><p>Use real, imperfect photographs here. Their honesty will matter more than polish.</p></div><div class="about-photo-grid">
<figure class="about-photo about-photo-large"><img src="/images/about/moment-ucla.jpg" alt="UCLA study and community placeholder" loading="lazy"><figcaption><strong>Study & community</strong><span>A classroom became a village.</span></figcaption></figure>
<figure class="about-photo"><img src="/images/about/moment-conversations.jpg" alt="Podcast and conversations placeholder" loading="lazy"><figcaption><strong>Conversations</strong><span>Listening before speaking.</span></figcaption></figure>
<figure class="about-photo"><img src="/images/about/moment-service.jpg" alt="Volunteering and community service placeholder" loading="lazy"><figcaption><strong>Service</strong><span>Contribution beyond oneself.</span></figcaption></figure>
<figure class="about-photo"><img src="/images/about/moment-family.jpg" alt="Family placeholder" loading="lazy"><figcaption><strong>Family</strong><span>My anchor through every move.</span></figcaption></figure>
<figure class="about-photo"><img src="/images/about/moment-dogs.jpg" alt="Percy and Pluto placeholder" loading="lazy"><figcaption><strong>Percy & Pluto</strong><span>Two unexpectedly good teachers.</span></figcaption></figure>
<figure class="about-photo about-photo-tall"><img src="/images/about/moment-writing.jpg" alt="Writing and reflection placeholder" loading="lazy"><figcaption><strong>Writing</strong><span>Slowing down enough to notice.</span></figcaption></figure>
</div></div></section>
