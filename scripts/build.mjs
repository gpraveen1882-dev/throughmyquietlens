...
function layout({title=site.title, description=site.description, body, active='', canonical='/', image='/images/through-my-quiet-lens-social.png'}) {
...
for (const e of essays) {
  ...
  write(`essays/${e.slug}`, layout({title:e.title, description:e.description, body, active:'essays', canonical:`/essays/${e.slug}/`, image:e.image || '/images/through-my-quiet-lens-social.png'}));
}
