...
if (fs.existsSync(page)) {
  ...
  html = html.replace('<div class="signal-state unknown">Periodic evidence</div><div class="signal-source">Census research supplement</div>', '<div class="signal-state mixed">Broad, shallow ↔</div><div class="signal-source">Census 2026 AI supplement</div>');
