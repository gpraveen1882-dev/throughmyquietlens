...
.thread-wrap{max-width:860px;margin:0 auto;padding:5rem 1.5rem 7rem}.thread-wrap h1{font-size:clamp(2.8rem,7vw,5.5rem);line-height:.98;max-width:680px;margin:.4rem 0 1.5rem}.thread-intro{font-size:1.25rem;line-height:1.7;max-width:650px}.thread-step{position:relative;margin:5rem 0;padding-left:2.2rem;border-left:1px solid rgba(0,0,0,.18)}.thread-step:before{content:"";position:absolute;left:-5px;top:.6rem;width:9px;height:9px;border-radius:50%;background:currentColor}.thread-step p{font-size:1.06rem;line-height:1.8;max-width:650px}.thread-question{font-family:Georgia,serif;font-size:1.55rem;line-height:1.5;margin:2rem 0}.thread-artifact{margin:2.2rem 0 1.2rem;padding:.55rem;background:#f6f1e8;border:1px solid rgba(67,55,44,.13);box-shadow:0 14px 34px rgba(49,39,30,.08);transform:rotate(-.28deg)}.thread-artifact.alt{transform:rotate(.22deg)}.thread-artifact img{display:block;width:100%;height:auto}.thread-caption{font-size:.84rem!important;line-height:1.5!important;color:rgba(45,37,31,.66);margin:.7rem .45rem 0!important;max-width:none!important}.thread-note{margin:1.4rem 0 2rem;padding:1rem 1.2rem;background:rgba(0,0,0,.035);font-size:.98rem}.thread-titles{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:.8rem;margin:2rem 0}.thread-titles div{padding:1rem;border-top:1px solid rgba(0,0,0,.18);font-family:Georgia,serif;font-size:1.08rem}.thread-ending{font-family:Georgia,serif;font-size:1.8rem;line-height:1.45;margin-top:5rem}.thread-back{margin-top:4rem}@media(max-width:640px){.thread-wrap{padding-top:3.2rem}.thread-step{margin:3.5rem 0;padding-left:1.4rem}.thread-artifact{margin-left:-.35rem;margin-right:-.35rem;padding:.35rem}.thread-titles{grid-template-columns:1fr}}
...
<section class="thread-step"><p>I tried.</p><figure class="thread-artifact alt"><img src="/images/thread/first-attempt-v2.svg" alt="Early personal-brand exercise describing Explorer and Caregiver archetypes"><figcaption class="thread-caption">An early attempt at putting the “me” into one sentence.</figcaption></figure><p>Some of it felt right. Some of it felt like an answer because the exercise needed an answer.</p></section>

<section class="thread-step"><p>And then I kept doing almost exactly what I had been doing before: writing about whatever stayed with me long enough.</p><div class="thread-titles"><div>Data centres</div><div>Dogs</div><div>AI</div><div>Family</div><div>Climate</div><div>People</div><div>Work</div><div>Boredom</div></div><div class="thread-note"><strong>This did not look particularly focused.</strong><br>Sometimes I was trying to understand something. Sometimes something bothered me. Sometimes it was simply a story I did not want to forget.</div></section>

<section class="thread-step"><p>I kept starting things too. Conversations. A podcast. Small experiments. Ideas that became projects, and ideas that did not.</p><p>Some found an audience. Many did not.</p><figure class="thread-artifact"><img src="/images/thread/harder-lesson-v2.svg" alt="A harder lesson slide about learning consistency and making peace with quiet response"><figcaption class="thread-caption">A harder lesson: response could not become the reason I wrote.</figcaption></figure><p>For a while, I wondered whether that meant I still had not found the thread.</p></section>
...
<section class="thread-step"><p>Through My Quiet Lens came later.</p><p>I needed somewhere to keep some of these things together. So I made one.</p><figure class="thread-artifact alt"><img src="/images/thread/where-it-led-v2.svg" alt="Slide showing the transition from a personal-brand statement to the Through My Quiet Lens website"><figcaption class="thread-caption">Eventually, I needed somewhere to put it all.</figcaption></figure><p>A piece about AI can sit next to something about a dog. A conversation can sit next to a half-formed project. Something serious can sit beside something quite ordinary.</p></section>
...
console.log('Published hidden thread page with original personal-brand artifacts and About doorway.');
