...
<section class="thread-step"><p>I tried.</p><figure class="thread-artifact alt"><img src="/images/thread/first-attempt.svg" alt="Early personal-brand exercise describing Explorer and Caregiver archetypes"><figcaption class="thread-caption">An early attempt at putting the “me” into one sentence.</figcaption></figure><p>Some of it felt right. Some of it felt like an answer because the exercise needed an answer.</p></section>
